...
<title>assignment_cnn/numpy_nn.py · master · B201_B4B33RPZ / RPZ python assignment templates · GitLab</title>
<script>
//<![CDATA[
...
gl.startup_graphql_calls = [{"query":"query getBlobInfo(\n  $projectPath: ID!\n  $filePath: [String!]!\n  $ref: String!\n  $refType: RefType\n  $shouldFetchRawText: Boolean!\n) {\n  project(fullPath: $projectPath) {\n    __typename\n    id\n    repository {\n      __typename\n      empty\n      blobs(paths: $filePath, ref: $ref, refType: $refType) {\n        __typename\n        nodes {\n          __typename\n          id\n          webPath\n          name\n          size\n          rawSize\n          rawTextBlob @include(if: $shouldFetchRawText)\n          fileType\n          language\n          path\n          blamePath\n          editBlobPath\n          gitpodBlobUrl\n          ideEditPath\n          forkAndEditPath\n          ideForkAndEditPath\n          codeNavigationPath\n          projectBlobPathRoot\n          forkAndViewPath\n          environmentFormattedExternalUrl\n          environmentExternalUrlForRouteMap\n          canModifyBlob\n          canModifyBlobWithWebIde\n          canCurrentUserPushToBranch\n          archived\n          storedExternally\n          externalStorage\n          externalStorageUrl\n          rawPath\n          replacePath\n          pipelineEditorPath\n          simpleViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n          richViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n        }\n      }\n    }\n  }\n}\n","variables":{"projectPath":"B201_B4B33RPZ/rpz-python-assignment-templates","ref":"master","refType":"HEADS","filePath":"assignment_cnn/numpy_nn.py","shouldFetchRawText":true}}];
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"zJa-qE6idPqGYkvxLRljB6eWx8h8OgKmHCh4bi69wrVOIXhLi3fOsipefL55_HekbumRpKDBBsbIUKd5hYDZtw","x-gitlab-feature-category":"source_code_management"};
...
<meta content="assignment_cnn/numpy_nn.py · master · B201_B4B33RPZ / RPZ python assignment templates · GitLab" property="og:title">
...
<meta content="https://gitlab.fel.cvut.cz/B201_B4B33RPZ/rpz-python-assignment-templates/-/blob/master/assignment_cnn/numpy_nn.py?ref_type=heads" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="assignment_cnn/numpy_nn.py · master · B201_B4B33RPZ / RPZ python assignment templates · GitLab" property="twitter:title">
...
<meta name="csrf-token" content="13fli1l2CeFxhNJbznu432UATptc-AhT4P53zi3LQu5VwCNonKOzqd245RSanqx8rH8Y94ADDDM0hqjZhvZZ7A" />
<meta name="csp-nonce" />
...
<body class="tab-width-8 gl-browser-safari gl-platform-mac " data-group="B201_B4B33RPZ" data-group-full-path="B201_B4B33RPZ" data-namespace-id="4724" data-page="projects:blob:show" data-page-type-id="master/assignment_cnn/numpy_nn.py" data-project="rpz-python-assignment-templates" data-project-full-path="B201_B4B33RPZ/rpz-python-assignment-templates" data-project-id="15745" data-project-studio-available="true" data-project-studio-enabled="true">
...
<div data-blob-path="assignment_cnn/numpy_nn.py" data-can-download-code="true" data-escaped-ref="master" data-full-name="B201_B4B33RPZ / RPZ python assignment templates" data-has-revs-file="false" data-original-branch="master" data-project-path="B201_B4B33RPZ/rpz-python-assignment-templates" data-ref-type="heads" data-resource-id="gid://gitlab/Project/15745" data-user-id="gid://gitlab/User/9575" id="js-view-blob-app">
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/stirband/rpz-python-assignment-templates/edit/master/-/assignment_cnn/numpy_nn.py'
